...
class IntentProcessor(DataProcessor):
    """Processor for the APMIC Intent classification ."""

    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "Intents", "train.tsv")),
            "train",
        )

    def get_dev_examples(self, data_dir):
        """See base class. 基本上不會測 """
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "Intents", "dev.tsv")), "dev"
        )

    def get_test_examples(self, data_dir):
        """See base class. 基本上不會測 """
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "Intents", "test.tsv")),
            "test",
        )
